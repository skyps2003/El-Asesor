  ...
  const team = [
    {
      ...
      email: "cesar.olguino@corporacionjjja.com",
      image: imgCesar,
      socials: { fb: '#', linkedin: '#', whatsapp: '51980706450' }
    },
    {
      name: "Dr. Jorge Ayquipa Mendoza",
      role: "Abogado Colegiado",
      desc: "Especialista en procesos laborales y civiles (CAL 32129).",
      email: "jorge.ayquipa@corporacionjjja.com",
      image: imgJorge,
      socials: { fb: '#', linkedin: '#', whatsapp: '51994715485' }
    },
    {
      ...
      email: "andre.jaramillo@corporacionjjja.com",
      image: imgAndre,
      socials: { fb: '#', linkedin: '#', whatsapp: '51954693867' }
    },
    {
      ...
      email: "victor.aguirre@corporacionjjja.com",
      image: imgVictor,
      socials: { fb: '#', linkedin: '#', whatsapp: '51954693867' }
    },
    {
      ...
      email: "jaime.marquez@corporacionjjja.com",
      image: imgNuevo,
      socials: { fb: '#', linkedin: '#', whatsapp: '51950792050' }
    },
    {
      name: "Jhon Jaramillo A.",
      role: "Administrador",
      desc: "Administrador con amplia experiencia en gestión empresarial.",
      email: "jhonn.jaramillo@corporacionjjja.com",
      ...
      <section className="container mx-auto px-6 mt-32 max-w-5xl">
        ...
        >
          ...
          <div className="md:w-1/3 flex flex-col items-center text-center relative z-10">
            ...
            <h3 className="text-2xl font-bold text-bgmain mb-1">CPCC. MG.<br />Juan Jaramillo</h3>
            ...
            <div className="flex gap-3 justify-center relative z-20">
              ...
              <a href={`https://wa.me/51994715485?text=${encodeURIComponent("Hola Dr. Juan Jaramillo, vengo del sitio web y quiero más información.")}`} target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-[#25D366] hover:border-[#25D366] hover:shadow-[0_0_15px_rgba(37,211,102,0.5)] transition-all duration-300 hover:-translate-y-1">
            ...
            >
              ...
              <div className="flex items-center justify-between border-t border-gray-100 pt-6 mt-auto w-full">
                <div className="flex gap-2">
                  <a href={`https://wa.me/${member.socials.whatsapp}?text=${encodeURIComponent(`Hola ${member.name}, vengo del sitio web y quiero más información.`)}`} target="_blank" rel="noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#25D366] hover:border-[#25D366] hover:shadow-[0_4px_10px_rgba(37,211,102,0.3)] transition-all duration-300 hover:-translate-y-1">
